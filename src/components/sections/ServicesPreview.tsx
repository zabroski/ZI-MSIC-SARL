...
export default function ServicesPreview() {
  return (
    <section className="servicesPreview">
      <div className="servicesPreview__container">
        <div className="servicesPreview__heading servicesPreview__heading--custom">
          <SectionTitle
            eyebrow="Nos expertises"
            title="Des services techniques complets pour les entreprises"
            text="Nous proposons des prestations adaptées à vos besoins opérationnels, techniques et sécuritaires."
            centered
            className="servicesPreview__titleWrapper"
            titleClassName="servicesPreview__title"
            textClassName="servicesPreview__text"
            eyebrowClassName="servicesPreview__eyebrow"
          />
        </div>
